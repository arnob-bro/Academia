            ...
            <div className="dashboard-container">
                <main className="dashboard-content">
                    ...
                    <div className="dashboard-cards">
                        <div className="card"><strong>Total Students:</strong> 1200</div>
                        <div className="card"><strong>Total Faculty:</strong> 80</div>
                        <div className="card"><strong>Active Courses:</strong> 35</div>
                    </div>
